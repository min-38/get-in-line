...
class EventServiceTest {
    ...
    @DisplayName("이벤트 정보를 주지 않으면, 생산 중단하고 결과를 false로 보여준다.")
    @Test
    void givenEvent_whenCreating_thenAbortEventAndReturnsFalse() {
        // given
    ...
    @Test
    void givenNotEventId_whenModifying_thenAbortModifyingAndReturnsFalse() {
        // given
        EventDTO dto = createEventDTO(1L, "오후 운동", false);
    ...
    @DisplayName("이벤트 ID만 주고 변경할 정보를 주지 않으면, 이벤트 정보 변경을 중단하고 결과를 false로 보여준다")
    @Test
    void givenNotEventIdOnly_whenModifying_thenAbortModifyingAndReturnsFalse() {
        // given
        long eventId = 1L;
    ...
    @Test
    void givenNotEventId_whenDeleting_thenDeletesEventAndReturnsTrue() {
        // given
        long eventId = 1L;
